 ...
 * ROLE_&lt;rol&gt;. TrainNow-Comunicaciones no tiene hoy ningún endpoint restringido por rol
 * (todo sigue permitAll en SecurityConfig), este filtro solo deja la infraestructura lista
 * por si en el futuro se quiere restringir algo, sin cambiar el comportamiento actual.
 */
@Component
