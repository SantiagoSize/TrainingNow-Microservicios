 ...
 * válido (mismo secreto compartido que TrainNow-Usuarios), publica un Authentication en el
 * SecurityContext con la autoridad ROLE_&lt;rol&gt;. Nunca lanza excepción ni corta la cadena:
 * si falta o es inválido, la request sigue como anónima y authorizeHttpRequests() decide.
 */
@Component
